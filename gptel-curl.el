...
(defun gptel-curl--stream-insert-response (response info &optional no-props no-transform)
...
Optional NO-TRANSFORM indicates that input should not be transformed."
  (cond
   ((stringp response)
